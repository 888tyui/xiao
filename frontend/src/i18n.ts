...
const resources = {
  en: {
    translation: {
      ...
      walletNeeded: 'Connect your Solana wallet to keep chatting after 5 messages.',
      ...
      freeMessages: 'Demo chats left: {{count}}',
  ...
  zh: {
    translation: {
      ...
      send: '发送',
      connectWallet: '连接钱包',
      walletNeeded: '超过 5 条对话需连接 Solana 钱包。',
